    ...
    <>
      ...
      <div className="sr-only" aria-hidden="true">
        ...
        <ul>
          ...
          <li>Tile Fabrication Services</li>
          <li>Marble and Granite Installation</li>
          <li>Bathroom and Kitchen Solutions</li>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-on-scroll max-w-4xl">
                ...
                <Link
                  ...
                  aria-label="Contact Our Team for tile solutions and consultations"
                >
              ...
              <div className="hidden lg:flex justify-center items-center">
                <div className="relative">
                  <img
                    src="/simlogo.webp"
                    alt="Simpolo Trading LLC Logo - Premium Tile Solutions Provider in UAE"
        ...
        <section className="py-24 bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <article className="animate-on-scroll" style={{ animationDelay: '0.2s' }}>
                <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 md:p-10 card-hover border border-gray-700 overflow-hidden relative group">
                  <div className="absolute inset-0 sword-shimmer opacity-0 group-hover:opacity-20 transition-opacity"></div>
                  <div className="flex items-center mb-8 relative z-10">
                    <div className="p-3 rounded-xl silver-gradient mr-4 relative overflow-hidden">
            ...
            <div className="animate-on-scroll">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
                {partners.map((partner, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-xs text-gray-500 group-hover:text-gray-400 transition-colors relative z-10">
                      Premium Partner
                    </p>
                  </article>
                ))}
              ...
              <div className="mt-16 text-center">
                <Link
                  ...
                  aria-label="View all our global partnerships and brands"
                >
                  <div className="absolute inset-0 sword-shimmer opacity-0 group-hover:opacity-30 transition-opacity"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 animate-on-scroll">
                <article className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 text-white border border-gray-700 relative overflow-hidden group">
                  <div className="absolute inset-0 sword-shimmer opacity-0 group-hover:opacity-20 transition-opacity"></div>
                  <h3 className="text-2xl font-bold mb-6 text-gray-300 relative z-10">Contact Our Team</h3>
                  <address className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10 not-italic">
              ...
              <div className="animate-on-scroll" style={{ animationDelay: '0.2s' }}>
                <article className="silver-gradient-dark rounded-2xl p-8 h-full border border-gray-600 relative overflow-hidden group">
                  <div className="absolute inset-0 sword-shimmer opacity-0 group-hover:opacity-20 transition-opacity"></div>
                  ...
                  <Link
                    ...
                    aria-label="Schedule a consultation with Simpolo Trading LLC"
                  >
                    <div className="absolute inset-0 sword-shimmer opacity-0 group-hover:opacity-30 transition-opacity"></div>
            ...
            <div className="animate-on-scroll">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Link
                  ...
                  aria-label="Start your tile project with Simpolo Trading LLC"
                >
                  <div className="absolute inset-0 sword-shimmer opacity-30"></div>
