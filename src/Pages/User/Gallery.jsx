    ...
    if (loading) {
      return (
        <div className="text-center py-24">
          ...
          <h3 className="text-xl font-bold text-white mb-4">Loading Gallery...</h3>
          <p className="text-gray-400">Please wait while we load our premium tile installations</p>
        </div>
      );
    }
      ...
      return (
        <div className="text-center py-24">
          ...
          <button
            ...
            className="group px-6 py-3 sword-gradient text-white rounded-xl font-medium hover:shadow-xl transition-all card-hover border border-gray-700 relative overflow-hidden silver-button-shine"
            aria-label="Reset all gallery filters"
          >
            <div className="absolute inset-0 sword-shimmer opacity-0 group-hover:opacity-30 transition-opacity"></div>
      ...
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {itemsToRender.map((item, index) => (
            ...
            >
              <meta itemProp="name" content={item.title || 'Tile Installation'} />
              <meta itemProp="description" content={item.description || 'Premium tile installation by Simpolo Trading'} />
              <meta itemProp="datePublished" content={item.createdAt} />
              ...
              <div className="relative h-96 overflow-hidden">
                ...
                <ImageWithFallback
                  ...
                  alt={item.images?.[0]?.altText || item.title || 'Tile installation gallery image'}
                ...
                <div className="absolute top-4 right-4 z-20">
                  <button
                    ...
                    aria-label={likedItems[item._id] ? `Unlike ${item.title}` : `Like ${item.title}`}
                  >
                    <Heart 
                      size={18} 
      ...
      <div className="sr-only" aria-hidden="true">
        ...
        <ul>
          {categories.slice(1).map((category, index) => (
            <li key={index}>{category} Gallery</li>
          ))}
        </ul>
        
        <h2>Featured Collections:</h2>
        <ul>
          <li>Luxury Villa Tile Installations</li>
          <li>Commercial Space Flooring</li>
          <li>Bathroom & Kitchen Tile Designs</li>
          <li>Swimming Pool Tile Projects</li>
          <li>Outdoor & Heavy-Duty Tile Applications</li>
        </ul>
        
        <p>View our portfolio of {gallery.length}+ successful projects completed across all Emirates including Dubai, Abu Dhabi, Sharjah, and more.</p>
      </div>
            ...
            <div className="animate-on-scroll max-w-4xl">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center text-gray-300">
                  <Award size={20} className="mr-2 text-gray-400" aria-hidden="true" />
                  <span>300+ Successful Projects</span>
                </div>
                <div className="flex items-center text-gray-300">
                  <Users size={20} className="mr-2 text-gray-400" aria-hidden="true" />
                  <span>Luxury & Commercial</span>
                </div>
                <div className="flex items-center text-gray-300">
                  <MapPin size={20} className="mr-2 text-gray-400" aria-hidden="true" />
              ...
              <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
                <div className="lg:w-2/3 flex flex-col border-r border-gray-700">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between z-20">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-2.5 bg-white/10 backdrop-blur-sm rounded-xl text-sm font-medium hover:bg-white/20 text-gray-300 hover:text-white transition-all duration-300 border border-gray-600 flex items-center gap-2 hover:shadow-lg"
                          aria-label={likedItems[selectedImage._id] ? 'Unlike image' : 'Like image'}
                        >
                          <Heart 
                            size={18} 
                  ...
                  <div className="p-4 bg-gray-800/50 border-t border-gray-700">
                    <h3 className="text-white font-medium mb-2">Gallery Preview</h3>
                ...
                <div className="lg:w-1/3 flex flex-col">
                  ...
                  >
                    ...
                    {selectedImage.specifications && Object.keys(selectedImage.specifications).length > 0 && (
                      <div>
                        <h4 className="text-lg font-bold text-white mb-3 flex items-center">
                          <Settings size={20} className="mr-2" aria-hidden="true" />
                          Specifications
                        </h4>
              ...
              <div className="animate-on-scroll">
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    ...
                    className="group px-8 py-4 silver-gradient text-gray-900 rounded-xl font-semibold hover:shadow-2xl transition-all duration-300 flex items-center space-x-3 card-hover relative overflow-hidden silver-button-shine"
                    aria-label="Get directions to our showroom"
                  >
                    <div className="absolute inset-0 sword-shimmer opacity-30"></div>
                  ...
                  <a
                    href="/contact"
                    className="group px-8 py-4 border-2 border-gray-600 text-white rounded-xl font-semibold hover:bg-white/10 hover:border-gray-400 transition-all duration-300 flex items-center space-x-3 card-hover relative overflow-hidden"
                ...
                <div className="p-12 lg:p-16 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a
                      ...
                      aria-label="Request a tile project quote"
                    >
                      <div className="absolute inset-0 sword-shimmer opacity-30"></div>
